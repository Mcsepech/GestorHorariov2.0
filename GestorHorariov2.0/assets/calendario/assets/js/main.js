(function() {
	...
	function ScheduleTemplate( element ) {
        ...
        this.modalButton = this.modal.getElementsByClassName('cd-schedule-modal__button')[0];
        this.modalButton1 = this.modal.getElementsByClassName('cd-schedule-modal__button1')[0];
        this.modalButton2 = this.modal.getElementsByClassName('cd-schedule-modal__button2')[0];
        this.modalButton3 = this.modal.getElementsByClassName('cd-schedule-modal__button3')[0];
	...
	ScheduleTemplate.prototype.openModal = function(target) {
        ...
        this.modalButton.textContent = target.getElementsByTagName('em')[1].textContent;
        this.modalButton1.textContent = target.getElementsByTagName('em')[2].textContent;
        this.modalButton2.textContent = target.getElementsByTagName('em')[3].textContent;
        this.modalButton3.textContent = target.getElementsByTagName('em')[4].textContent;
